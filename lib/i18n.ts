...
const translations = {
  ...
  // ── Onboarding Tour ──────────────────────────────────────────
  "tour.step1.title": { en: "Getting Started", es: "Primeros pasos" },
  "tour.step1.desc": { en: "Welcome to CPA Mastery! Use the sidebar (or bottom tabs on mobile) to navigate between sections. Let's walk through each one.", es: "¡Bienvenido a CPA Mastery! Usa la barra lateral (o las pestañas en móvil) para navegar entre secciones. Veamos cada una." },
  "tour.step2.title": { en: "Your Progress at a Glance", es: "Tu progreso de un vistazo" },
  "tour.step2.desc": { en: "These cards show your total study hours and current streak. Study consistently every day to build your streak — even 30 minutes counts!", es: "Estas tarjetas muestran tus horas totales de estudio y tu racha actual. Estudia consistentemente cada día para mantener tu racha — ¡incluso 30 minutos cuenta!" },
  "tour.step3.title": { en: "Chapters — Start Here", es: "Capítulos — Empieza aquí" },
  "tour.step3.desc": { en: "Browse all chapters organized by exam section (FAR, AUD, REG, etc.). Tap a chapter to open its detail page, where you can record study sessions and save key insights as Essence Notes.", es: "Explora todos los capítulos organizados por sección de examen (FAR, AUD, REG, etc.). Toca un capítulo para abrir su página de detalle, donde puedes registrar sesiones de estudio y guardar ideas clave como Notas Esenciales." },
  "tour.step4.title": { en: "Study Log — Track Every Session", es: "Registro — Registra cada sesión" },
  "tour.step4.desc": { en: "Record each study session: date, hours, MC/TBS questions answered, and accuracy. Tap \"New Entry\", pick a section and chapter, fill in your numbers, and save. Weekly summaries show your study patterns automatically.", es: "Registra cada sesión de estudio: fecha, horas, preguntas MC/TBS respondidas y precisión. Toca \"Nueva entrada\", elige sección y capítulo, completa los datos y guarda. Los resúmenes semanales muestran tus patrones de estudio automáticamente." },
  "tour.step5.title": { en: "Practice Exam — Simulate Test Day", es: "Examen de práctica — Simula el día del examen" },
  "tour.step5.desc": { en: "Log your mock exam scores by section. Track MC and TBS results separately. The score trend chart shows your improvement over time — aim for 75+ to pass!", es: "Registra tus puntuaciones de exámenes de práctica por sección. Rastrea resultados MC y TBS por separado. El gráfico de tendencia muestra tu mejora — ¡apunta a 75+ para aprobar!" },
  "tour.step6.title": { en: "Review — Beat the Forgetting Curve", es: "Repaso — Vence la curva del olvido" },
  "tour.step6.desc": { en: "Chapters are ranked by memory retention using spaced repetition. Red = overdue (review now!), yellow = due today, green = well retained. Tap a chapter to see its forgetting curve and rate your recall.", es: "Los capítulos se ordenan por retención de memoria usando repetición espaciada. Rojo = vencido (¡repasa ahora!), amarillo = para hoy, verde = bien retenido. Toca un capítulo para ver su curva del olvido y calificar tu recuerdo." },
  "tour.step7.title": { en: "Analytics — Strategic Insights", es: "Analíticas — Información estratégica" },
  "tour.step7.desc": { en: "Get data-driven guidance: goal pace tracking, risk radar for potential issues, retention calibration, and coverage gap analysis. Set an exam date in Settings to unlock pace analysis.", es: "Obtén orientación basada en datos: seguimiento del ritmo, radar de riesgos, calibración de retención y análisis de brechas de cobertura. Establece una fecha de examen en Ajustes para activar el análisis de ritmo." },
  "tour.step8.title": { en: "Settings — Customize Your Experience", es: "Ajustes — Personaliza tu experiencia" },
  "tour.step8.desc": { en: "Set your profile, exam dates and target scores per section, daily study goals, and notification preferences. Your exam date powers the pace analysis in Analytics.", es: "Configura tu perfil, fechas de examen y puntajes meta por sección, metas diarias de estudio y preferencias de notificación. Tu fecha de examen alimenta el análisis de ritmo en Analíticas." },
  "tour.step9.title": { en: "Streaks & Notifications", es: "Rachas y notificaciones" },
  "tour.step9.desc": { en: "Keep your streak alive by studying every day! Enable browser notifications in Settings to get alerts for overdue reviews, streak protection, weekly summaries, and milestone celebrations.", es: "¡Mantén tu racha estudiando cada día! Activa las notificaciones del navegador en Ajustes para recibir alertas de repasos vencidos, protección de racha, resúmenes semanales y celebraciones de hitos." },
  "tour.step10.title": { en: "You're All Set!", es: "¡Todo listo!" },
  "tour.step10.desc": { en: "Start by opening Chapters and recording your first study session. Your dashboard, review schedule, and analytics will come alive as you add data. Good luck on your CPA journey!", es: "Comienza abriendo Capítulos y registrando tu primera sesión de estudio. Tu panel, calendario de repaso y analíticas cobrarán vida a medida que agregues datos. ¡Buena suerte en tu camino hacia el CPA!" },
