...
const translations = {
  ...
  "analytics.retention.help.title": { en: "Compares predicted retention with your actual recall:", es: "Compara la retención predicha con tu recuerdo real:", ja: "予測保持率と実際の想起率を比較：" },
