...
export const CHAPTER_TITLES_JA: Record<string, string> = {
  // FAR
  "far-ch1": "財務会計の基本的概念と財務諸表",
  "far-ch2": "財務諸表の表示と開示・認識と測定の概念",
  "far-ch3": "流動資産（現金・売掛金・棚卸資産）",
  "far-ch4": "流動負債と偶発事象",
  "far-ch5": "有形固定資産",
  "far-ch6": "無形資産",
  "far-ch7": "貨幣の時間価値",
  ...
  "far-ch9": "借手のリース会計",
  "far-ch10": "受取手形と支払手形",
  "far-ch11": "顧客との契約に基づく収益の認識",
  "far-ch12": "資本取引と1株当たり利益",
  "far-ch13": "投資",
  "far-ch14": "連結財務諸表の作成と企業結合後の調整",
  "far-ch15": "税効果会計",
  "far-ch16": "キャッシュ・フロー計算書",
  "far-ch17": "会計上の変更と誤謬の修正",
  "far-ch18": "その他のトピック",
  "far-ch19": "財務指標と経営指標",
  "far-ch20": "非政府系の非営利組織",
  "far-ch21": "政府会計",
  // AUD
  "aud-ch1": "財務諸表監査概論",
  "aud-ch2": "財務諸表監査における重要な概念",
  "aud-ch3": "財務諸表監査報告書　パート１",
  "aud-ch4": "財務諸表監査報告書　パート２",
  "aud-ch5": "監査計画",
  "aud-ch6": "内部統制　パート１",
  "aud-ch7": "内部統制　パート２",
  "aud-ch8": "実証性テスト　パート１",
  "aud-ch9": "実証性テスト　パート２",
  "aud-ch10": "財務報告に係る内部統制監査",
  "aud-ch11": "基準で要求されるその他の監査手続き",
  "aud-ch12": "監査におけるその他の考慮事項",
  "aud-ch13": "財務諸表監査に係るその他の報告書",
  "aud-ch14": "監査手続きケーススタディ",
  "aud-ch15": "会計及びレビュー業務",
  "aud-ch16": "証明及び保証業務",
  "aud-ch17": "IT監査",
  "aud-ch18": "監査サンプリング",
  "aud-ch19": "監査人の法的・倫理的責任",
  "aud-ch20": "監査データ分析",
  "aud-ch21": "経済学",
  "aud-ch22": "ミクロ経済学",
  "aud-ch23": "マクロ経済学",
  ...
  "reg-ch8": "破産",
  "reg-ch9": "事業組織",
  "reg-ch10": "政府による規制と専門職としての責任",
  "reg-ch11": "[参考資料] 連邦証券法",
  "reg-ch12": "序論",
  "reg-ch13": "個人 パート１ 概論と総所得",
  "reg-ch14": "個人 パート２ 事業所得と事業経費",
  "reg-ch15": "個人 パート３ 控除項目",
  "reg-ch16": "個人 パート４ 税額の計算",
  "reg-ch17": "資産取引",
  "reg-ch18": "パートナーシップ　パート１",
  "reg-ch19": "パートナーシップ　パート２",
  "reg-ch20": "株式会社",
  "reg-ch21": "小規模会社",
  "reg-ch22": "税に関するその他トピック",
  "reg-ch23": "納税申告書の代書作成者の責任",
  // BEC
  "bec-ch1": "原価計算の基礎",
  "bec-ch2": "製品別原価計算",
  "bec-ch3": "意思決定のためのコスト情報",
  "bec-ch4": "計画、予算、及び管理",
  "bec-ch5": "業績評価指標",
  "bec-ch6": "ファイナンス序論",
  "bec-ch7": "運転資本の管理",
  "bec-ch8": "投資意思決定",
  "bec-ch9": "リスク、リターンと資本コスト",
  "bec-ch10": "資金調達の意思決定",
  "bec-ch11": "全社的リスクマネジメント",
  "bec-ch12": "経済学",
  "bec-ch13": "無形資産の応用的な会計処理",
  "bec-ch14": "株式に基づく報酬",
  "bec-ch15": "企業結合",
  "bec-ch16": "財務諸表の換算",
  "bec-ch17": "デリバティブ",
  "bec-ch18": "リースの応用的な会計処理",
  "bec-ch19": "公開企業の財務報告に関する論点",
  "bec-ch20": "年金と退職給付制度",
  "bec-ch21": "その他の応用論点",
  "bec-ch22": "政府の財務報告",
  "bec-ch23": "予算会計",
  "bec-ch24": "政府型活動-収益認識",
  "bec-ch25": "政府型活動-費用と支出認識",
  "bec-ch26": "政府型活動-資本資産取得ファンドと長期債務処理",
  "bec-ch27": "政府型活動-その他",
  "bec-ch28": "事業型活動および内部サービス",
  "bec-ch29": "恒久基金と受託会計",
  // TCP
  "tcp-ch1": "個人 パート1 総所得と控除項目",
  "tcp-ch2": "個人 パート2 損失控除制限",
  "tcp-ch3": "個人 パート3 贈与税と遺産税",
  "tcp-ch4": "個人 パート4 ファイナンシャル・プランニング",
  "tcp-ch5": "パートナーシップ",
  "tcp-ch6": "株式会社",
  "tcp-ch7": "小規模会社",
  "tcp-ch8": "事業体の設立と清算",
  "tcp-ch9": "信託と遺産",
  "tcp-ch10": "税に関するその他のトピック",
  "tcp-ch11": "資産取引",
  // ISC
  "isc-ch1": "情報システム",
  "isc-ch2": "ITガバナンス",
  "isc-ch3": "情報システム部門の役割と責任",
  "isc-ch4": "内部統制",
  "isc-ch5": "リスクマネジメント",
  "isc-ch6": "業務継続計画",
  "isc-ch7": "災害復旧計画",
  "isc-ch8": "情報セキュリティの法規制とフレームワーク",
  "isc-ch9": "情報セキュリティ管理",
  "isc-ch10": "情報システムに対する脅威と攻撃",
  "isc-ch11": "Trustサービス規準",
  "isc-ch12": "SOC報告書",
}
