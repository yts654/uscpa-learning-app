...
export const STUDY_LOGS: StudyLog[] = [
  // ── far-ch1: Mastered (7 reviews, 1日前) ~99% ──
  { id: "log-01", date: "2026-01-05", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 2.5, mcQuestions: 20, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 2, questionsAnswered: 25, correctAnswers: 14, memo: "Initial study. Accounting equation basics." },
  { id: "log-02", date: "2026-01-08", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 1.5, mcQuestions: 15, mcCorrect: 12, tbsQuestions: 3, tbsCorrect: 2, questionsAnswered: 18, correctAnswers: 14, memo: "1st review. Double-entry solidifying." },
  { id: "log-03", date: "2026-01-15", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 1.0, mcQuestions: 15, mcCorrect: 14, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 18, memo: "2nd review. GAAP framework clear." },
  { id: "log-04", date: "2026-01-25", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 1.0, mcQuestions: 20, mcCorrect: 19, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 25, correctAnswers: 24, memo: "3rd review. Near perfect." },
  { id: "log-05", date: "2026-02-05", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 0.5, mcQuestions: 10, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 15, correctAnswers: 15, memo: "4th review. Perfect score." },
  { id: "log-06", date: "2026-02-12", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 0.5, mcQuestions: 10, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 15, correctAnswers: 15, memo: "5th review. Fully confident." },
  { id: "log-07", date: "2026-02-18", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 0.5, mcQuestions: 10, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 15, correctAnswers: 15, memo: "6th review. Mastered." },
  // ── far-ch2: Mastered (6 reviews, 2日前) ~98% ──
  { id: "log-08", date: "2026-01-08", section: "FAR", chapterId: "far-ch2", chapterTitle: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", studyHours: 2.0, mcQuestions: 18, mcCorrect: 11, tbsQuestions: 2, tbsCorrect: 1, questionsAnswered: 20, correctAnswers: 12, memo: "Disclosure details are dense." },
  { id: "log-09", date: "2026-01-11", section: "FAR", chapterId: "far-ch2", chapterTitle: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", studyHours: 1.5, mcQuestions: 15, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 15, memo: "1st review. Recognition criteria clearer." },
  { id: "log-10", date: "2026-01-20", section: "FAR", chapterId: "far-ch2", chapterTitle: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", studyHours: 1.0, mcQuestions: 15, mcCorrect: 14, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 18, memo: "2nd review. Measurement concepts solid." },
  { id: "log-11", date: "2026-01-30", section: "FAR", chapterId: "far-ch2", chapterTitle: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", studyHours: 1.0, mcQuestions: 20, mcCorrect: 18, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 25, correctAnswers: 23, memo: "3rd review. Strong." },
  { id: "log-12", date: "2026-02-10", section: "FAR", chapterId: "far-ch2", chapterTitle: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", studyHours: 0.5, mcQuestions: 10, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 15, correctAnswers: 14, memo: "4th review." },
  { id: "log-13", date: "2026-02-17", section: "FAR", chapterId: "far-ch2", chapterTitle: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", studyHours: 0.5, mcQuestions: 10, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 15, correctAnswers: 15, memo: "5th review. Mastered." },
  // ── far-ch3: Mastered (5 reviews, 3日前) ~93% ──
  { id: "log-14", date: "2026-01-12", section: "FAR", chapterId: "far-ch3", chapterTitle: "Current Assets (Cash, Accounts Receivable, Inventory)", studyHours: 2.0, mcQuestions: 15, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 13, memo: "FIFO vs LIFO vs weighted average." },
  { id: "log-15", date: "2026-01-18", section: "FAR", chapterId: "far-ch3", chapterTitle: "Current Assets (Cash, Accounts Receivable, Inventory)", studyHours: 1.5, mcQuestions: 15, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 17, memo: "1st review. AR allowance method clear." },
  { id: "log-16", date: "2026-01-28", section: "FAR", chapterId: "far-ch3", chapterTitle: "Current Assets (Cash, Accounts Receivable, Inventory)", studyHours: 1.0, mcQuestions: 15, mcCorrect: 14, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 18, memo: "2nd review. LCM rule understood." },
  { id: "log-17", date: "2026-02-08", section: "FAR", chapterId: "far-ch3", chapterTitle: "Current Assets (Cash, Accounts Receivable, Inventory)", studyHours: 0.5, mcQuestions: 15, mcCorrect: 15, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 19, memo: "3rd review. Almost perfect." },
  { id: "log-18", date: "2026-02-16", section: "FAR", chapterId: "far-ch3", chapterTitle: "Current Assets (Cash, Accounts Receivable, Inventory)", studyHours: 0.5, mcQuestions: 10, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 15, correctAnswers: 15, memo: "4th review. Solid." },
  // ── far-ch4: Mastered (5 reviews, 5日前) ~89% ──
  { id: "log-19", date: "2026-01-15", section: "FAR", chapterId: "far-ch4", chapterTitle: "Current Liabilities and Contingencies", studyHours: 2.0, mcQuestions: 15, mcCorrect: 9, tbsQuestions: 5, tbsCorrect: 2, questionsAnswered: 20, correctAnswers: 11, memo: "Contingent liabilities tricky." },
  { id: "log-20", date: "2026-01-20", section: "FAR", chapterId: "far-ch4", chapterTitle: "Current Liabilities and Contingencies", studyHours: 1.5, mcQuestions: 15, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 15, memo: "1st review. Probable vs possible clearer." },
  { id: "log-21", date: "2026-01-30", section: "FAR", chapterId: "far-ch4", chapterTitle: "Current Liabilities and Contingencies", studyHours: 1.0, mcQuestions: 15, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 17, memo: "2nd review. Warranty accruals clear." },
  { id: "log-22", date: "2026-02-08", section: "FAR", chapterId: "far-ch4", chapterTitle: "Current Liabilities and Contingencies", studyHours: 0.5, mcQuestions: 15, mcCorrect: 14, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 20, correctAnswers: 19, memo: "3rd review. Confident." },
  { id: "log-23", date: "2026-02-14", section: "FAR", chapterId: "far-ch4", chapterTitle: "Current Liabilities and Contingencies", studyHours: 0.5, mcQuestions: 10, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 15, correctAnswers: 15, memo: "4th review. Strong." },
  // ── far-ch5: Reviewing (4 reviews, 3日前) ~86% ──
  { id: "log-24", date: "2026-01-18", section: "FAR", chapterId: "far-ch5", chapterTitle: "Property, Plant, and Equipment", studyHours: 2.5, mcQuestions: 20, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 2, questionsAnswered: 25, correctAnswers: 15, memo: "Depreciation methods and impairment." },
  { id: "log-25", date: "2026-01-23", section: "FAR", chapterId: "far-ch5", chapterTitle: "Property, Plant, and Equipment", studyHours: 1.5, mcQuestions: 15, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 15, memo: "1st review. SL vs DDB clearer." },
  { id: "log-26", date: "2026-02-02", section: "FAR", chapterId: "far-ch5", chapterTitle: "Property, Plant, and Equipment", studyHours: 1.0, mcQuestions: 15, mcCorrect: 14, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 18, memo: "2nd review. Component depreciation." },
  { id: "log-27", date: "2026-02-16", section: "FAR", chapterId: "far-ch5", chapterTitle: "Property, Plant, and Equipment", studyHours: 0.5, mcQuestions: 10, mcCorrect: 9, tbsQuestions: 5, tbsCorrect: 5, questionsAnswered: 15, correctAnswers: 14, memo: "3rd review. Good." },
  // ── far-ch6: Reviewing (4 reviews, 6日前) ~74% ──
  { id: "log-28", date: "2026-01-20", section: "FAR", chapterId: "far-ch6", chapterTitle: "Intangible Assets", studyHours: 1.5, mcQuestions: 12, mcCorrect: 7, tbsQuestions: 3, tbsCorrect: 1, questionsAnswered: 15, correctAnswers: 8, memo: "Goodwill impairment and amortization." },
  { id: "log-29", date: "2026-01-25", section: "FAR", chapterId: "far-ch6", chapterTitle: "Intangible Assets", studyHours: 1.0, mcQuestions: 12, mcCorrect: 10, tbsQuestions: 3, tbsCorrect: 2, questionsAnswered: 15, correctAnswers: 12, memo: "1st review. Finite vs indefinite-lived." },
  { id: "log-30", date: "2026-02-04", section: "FAR", chapterId: "far-ch6", chapterTitle: "Intangible Assets", studyHours: 1.0, mcQuestions: 15, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 17, memo: "2nd review. R&D costs clear." },
  { id: "log-31", date: "2026-02-13", section: "FAR", chapterId: "far-ch6", chapterTitle: "Intangible Assets", studyHours: 0.5, mcQuestions: 10, mcCorrect: 9, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 15, correctAnswers: 13, memo: "3rd review." },
  // ── far-ch7: Reviewing (3 reviews, 4日前) ~67% ──
  { id: "log-32", date: "2026-01-28", section: "FAR", chapterId: "far-ch7", chapterTitle: "Time Value of Money", studyHours: 2.0, mcQuestions: 15, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 13, memo: "PV / FV calculations. Annuity types." },
  { id: "log-33", date: "2026-02-05", section: "FAR", chapterId: "far-ch7", chapterTitle: "Time Value of Money", studyHours: 1.0, mcQuestions: 15, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 17, memo: "1st review. Ordinary vs annuity due." },
  { id: "log-34", date: "2026-02-15", section: "FAR", chapterId: "far-ch7", chapterTitle: "Time Value of Money", studyHours: 1.0, mcQuestions: 15, mcCorrect: 14, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 18, memo: "2nd review. Good progress." },
  // ── far-ch8: Reviewing (3 reviews, 2日前) ~82% ──
  { id: "log-35", date: "2026-01-30", section: "FAR", chapterId: "far-ch8", chapterTitle: "Bonds", studyHours: 2.0, mcQuestions: 15, mcCorrect: 8, tbsQuestions: 5, tbsCorrect: 2, questionsAnswered: 20, correctAnswers: 10, memo: "Effective interest method. Tough." },
  { id: "log-36", date: "2026-02-08", section: "FAR", chapterId: "far-ch8", chapterTitle: "Bonds", studyHours: 1.5, mcQuestions: 15, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 15, memo: "1st review. Premium vs discount clearer." },
  { id: "log-37", date: "2026-02-17", section: "FAR", chapterId: "far-ch8", chapterTitle: "Bonds", studyHours: 1.0, mcQuestions: 15, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 17, memo: "2nd review. Amortization tables solid." },
  // ── far-ch9: Learning (2 reviews, 2日前) ~63% ──
  { id: "log-38", date: "2026-02-10", section: "FAR", chapterId: "far-ch9", chapterTitle: "Lease Accounting for Lessee", studyHours: 2.0, mcQuestions: 15, mcCorrect: 9, tbsQuestions: 5, tbsCorrect: 2, questionsAnswered: 20, correctAnswers: 11, memo: "ASC 842. Finance vs operating leases." },
  { id: "log-39", date: "2026-02-17", section: "FAR", chapterId: "far-ch9", chapterTitle: "Lease Accounting for Lessee", studyHours: 1.5, mcQuestions: 15, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 15, memo: "1st review. ROU asset calculation." },
  // ── far-ch10: Learning (2 reviews, 3日前) ~50% ──
  { id: "log-40", date: "2026-02-08", section: "FAR", chapterId: "far-ch10", chapterTitle: "Notes Receivable and Payable", studyHours: 1.5, mcQuestions: 12, mcCorrect: 8, tbsQuestions: 3, tbsCorrect: 1, questionsAnswered: 15, correctAnswers: 9, memo: "Imputed interest and discount notes." },
  { id: "log-41", date: "2026-02-16", section: "FAR", chapterId: "far-ch10", chapterTitle: "Notes Receivable and Payable", studyHours: 1.0, mcQuestions: 12, mcCorrect: 10, tbsQuestions: 3, tbsCorrect: 2, questionsAnswered: 15, correctAnswers: 12, memo: "1st review. Non-interest bearing notes." },
  // ── far-ch11: Reviewing (4 reviews, 8日前) ~67% ──
  { id: "log-42", date: "2026-01-18", section: "FAR", chapterId: "far-ch11", chapterTitle: "Revenue from Contracts with Customers", studyHours: 2.5, mcQuestions: 20, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 2, questionsAnswered: 25, correctAnswers: 14, memo: "ASC 606 five-step model." },
  { id: "log-43", date: "2026-01-25", section: "FAR", chapterId: "far-ch11", chapterTitle: "Revenue from Contracts with Customers", studyHours: 1.5, mcQuestions: 15, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 15, memo: "1st review. Performance obligations." },
  { id: "log-44", date: "2026-02-04", section: "FAR", chapterId: "far-ch11", chapterTitle: "Revenue from Contracts with Customers", studyHours: 1.0, mcQuestions: 15, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 20, correctAnswers: 17, memo: "2nd review. Variable consideration." },
  { id: "log-45", date: "2026-02-11", section: "FAR", chapterId: "far-ch11", chapterTitle: "Revenue from Contracts with Customers", studyHours: 0.5, mcQuestions: 10, mcCorrect: 9, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 15, correctAnswers: 13, memo: "3rd review." },
  // ── far-ch12: Learning (1 review, 1日前) ~50% ──
  { id: "log-46", date: "2026-02-18", section: "FAR", chapterId: "far-ch12", chapterTitle: "Equity Transactions and Earnings Per Share", studyHours: 2.0, mcQuestions: 15, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 13, memo: "Treasury stock methods. Basic vs diluted EPS." },
  // ── far-ch13: Learning (2 reviews, 5日前) ~32% ──
  { id: "log-47", date: "2026-02-05", section: "FAR", chapterId: "far-ch13", chapterTitle: "Investments", studyHours: 1.5, mcQuestions: 10, mcCorrect: 7, tbsQuestions: 2, tbsCorrect: 1, questionsAnswered: 12, correctAnswers: 8, memo: "Debt vs equity. Fair value levels." },
  { id: "log-48", date: "2026-02-14", section: "FAR", chapterId: "far-ch13", chapterTitle: "Investments", studyHours: 1.0, mcQuestions: 12, mcCorrect: 9, tbsQuestions: 3, tbsCorrect: 2, questionsAnswered: 15, correctAnswers: 11, memo: "1st review. Equity method clearer." },
  // ── far-ch14: Overdue (2 reviews, 8日前) ~16% ──
  { id: "log-49", date: "2026-02-02", section: "FAR", chapterId: "far-ch14", chapterTitle: "Preparation of Consolidated Financial Statements and Adjustments Subsequent to Combination", studyHours: 2.5, mcQuestions: 15, mcCorrect: 8, tbsQuestions: 5, tbsCorrect: 2, questionsAnswered: 20, correctAnswers: 10, memo: "Elimination entries. NCI calculation." },
  { id: "log-50", date: "2026-02-11", section: "FAR", chapterId: "far-ch14", chapterTitle: "Preparation of Consolidated Financial Statements and Adjustments Subsequent to Combination", studyHours: 1.5, mcQuestions: 15, mcCorrect: 10, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 20, correctAnswers: 13, memo: "1st review. Intercompany eliminations still fuzzy." },
  // ── far-ch15: Overdue (1 review, 10日前) ~0% ──
  { id: "log-51", date: "2026-02-09", section: "FAR", chapterId: "far-ch15", chapterTitle: "Deferred Taxes", studyHours: 2.0, mcQuestions: 15, mcCorrect: 7, tbsQuestions: 5, tbsCorrect: 1, questionsAnswered: 20, correctAnswers: 8, memo: "Temporary vs permanent differences. Valuation allowance." },
]
...
export const INITIAL_MOCK_EXAMS: MockExam[] = [
  // FAR — 3 attempts, scores improving
  {
    id: "mock-1",
    date: "2026-01-15",
    section: "FAR",
    ...
    totalCorrect: 23,
    accuracy: 52.3,
    memo: "First attempt. Weak on consolidation and government accounting.",
  },
  {
    id: "mock-2",
    date: "2026-02-01",
    ...
    totalCorrect: 31,
    accuracy: 70.5,
    memo: "Big improvement on MC. TBS still needs work on lease calculations.",
  },
  {
    id: "mock-3",
    date: "2026-02-15",
    ...
    totalCorrect: 36,
    accuracy: 81.8,
    memo: "Feeling confident. Bonds and revenue recognition solid.",
  },
  // AUD — 2 attempts
  {
    id: "mock-4",
    ...
    totalCorrect: 26,
    accuracy: 59.1,
    memo: "Audit reports and sampling were tricky.",
  },
  {
    id: "mock-5",
    date: "2026-02-10",
    ...
    totalCorrect: 33,
    accuracy: 75.0,
    memo: "Internal controls and IT auditing much better.",
  },
  // REG — 1 attempt
  {
    id: "mock-6",
    ...
    totalCorrect: 21,
    accuracy: 47.7,
    memo: "Partnership taxation and property transactions need more study.",
  },
]
...
export const INITIAL_ESSENCE_NOTES: EssenceNote[] = [
  {
    ...
    insights: [
      { type: "concept", title: "Accounting Equation", body: "Assets = Liabilities + Equity is the foundation of all double-entry bookkeeping. Every transaction must maintain this equation." },
      { type: "framework", title: "Journal Entry Thinking", body: "When you see a transaction: (1) What increased and what decreased? → (2) Is it an Asset, Liability, or Equity? → (3) Should it be debited or credited?" },
      { type: "trap", title: "GAAP vs IFRS Confusion", body: "US GAAP is rules-based (specific criteria), IFRS is principles-based (more judgment). Always check which framework the question is asking about." },
    ],
