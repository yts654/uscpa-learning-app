...
export const CHAPTERS: Chapter[] = [
  // FAR Chapters — 19/21 completed (~90%), retention varies
  { id: "far-ch1", section: "FAR", number: 1, title: "Basic Concepts of Financial Accounting and Financial Statements", totalQuestions: 30, correctAnswers: 27, studyHours: 4.5, lastStudied: "2026-01-15", status: "completed", essenceNotes: [] },
  { id: "far-ch2", section: "FAR", number: 2, title: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", totalQuestions: 28, correctAnswers: 22, studyHours: 4, lastStudied: "2026-01-17", status: "completed", essenceNotes: [] },
  { id: "far-ch3", section: "FAR", number: 3, title: "Current Assets (Cash, Accounts Receivable, Inventory)", totalQuestions: 35, correctAnswers: 25, studyHours: 5.5, lastStudied: "2026-01-20", status: "completed", essenceNotes: [] },
  { id: "far-ch4", section: "FAR", number: 4, title: "Current Liabilities and Contingencies", totalQuestions: 22, correctAnswers: 18, studyHours: 3.5, lastStudied: "2026-01-22", status: "completed", essenceNotes: [] },
  { id: "far-ch5", section: "FAR", number: 5, title: "Property, Plant, and Equipment", totalQuestions: 30, correctAnswers: 24, studyHours: 5, lastStudied: "2026-01-25", status: "completed", essenceNotes: [] },
  { id: "far-ch6", section: "FAR", number: 6, title: "Intangible Assets", totalQuestions: 20, correctAnswers: 16, studyHours: 3, lastStudied: "2026-01-27", status: "completed", essenceNotes: [] },
  { id: "far-ch7", section: "FAR", number: 7, title: "Time Value of Money", totalQuestions: 18, correctAnswers: 11, studyHours: 4, lastStudied: "2026-01-29", status: "completed", essenceNotes: [] },
  { id: "far-ch8", section: "FAR", number: 8, title: "Bonds", totalQuestions: 25, correctAnswers: 15, studyHours: 5, lastStudied: "2026-01-31", status: "completed", essenceNotes: [] },
  { id: "far-ch9", section: "FAR", number: 9, title: "Lease Accounting for Lessee", totalQuestions: 22, correctAnswers: 13, studyHours: 4.5, lastStudied: "2026-02-02", status: "completed", essenceNotes: [] },
  { id: "far-ch10", section: "FAR", number: 10, title: "Notes Receivable and Payable", totalQuestions: 18, correctAnswers: 14, studyHours: 3, lastStudied: "2026-02-04", status: "completed", essenceNotes: [] },
  { id: "far-ch11", section: "FAR", number: 11, title: "Revenue from Contracts with Customers", totalQuestions: 25, correctAnswers: 16, studyHours: 5, lastStudied: "2026-02-06", status: "completed", essenceNotes: [] },
  { id: "far-ch12", section: "FAR", number: 12, title: "Equity Transactions and Earnings Per Share", totalQuestions: 22, correctAnswers: 15, studyHours: 4, lastStudied: "2026-02-08", status: "completed", essenceNotes: [] },
  { id: "far-ch13", section: "FAR", number: 13, title: "Investments", totalQuestions: 20, correctAnswers: 14, studyHours: 4, lastStudied: "2026-02-10", status: "completed", essenceNotes: [] },
  { id: "far-ch14", section: "FAR", number: 14, title: "Preparation of Consolidated Financial Statements and Adjustments Subsequent to Combination", totalQuestions: 28, correctAnswers: 16, studyHours: 6, lastStudied: "2026-02-12", status: "completed", essenceNotes: [] },
  { id: "far-ch15", section: "FAR", number: 15, title: "Deferred Taxes", totalQuestions: 22, correctAnswers: 14, studyHours: 4.5, lastStudied: "2026-02-14", status: "completed", essenceNotes: [] },
  { id: "far-ch16", section: "FAR", number: 16, title: "Statement of Cash Flows", totalQuestions: 25, correctAnswers: 19, studyHours: 4, lastStudied: "2026-02-16", status: "completed", essenceNotes: [] },
  { id: "far-ch17", section: "FAR", number: 17, title: "Accounting Changes and Error Corrections", totalQuestions: 18, correctAnswers: 12, studyHours: 3.5, lastStudied: "2026-02-18", status: "completed", essenceNotes: [] },
  { id: "far-ch18", section: "FAR", number: 18, title: "Miscellaneous Topics", totalQuestions: 15, correctAnswers: 11, studyHours: 3, lastStudied: "2026-02-20", status: "completed", essenceNotes: [] },
  { id: "far-ch19", section: "FAR", number: 19, title: "Financial Statement Ratios and Performance Metrics", totalQuestions: 12, correctAnswers: 8, studyHours: 2.5, lastStudied: "2026-02-22", status: "in-progress", essenceNotes: [] },
...
export const STUDY_LOGS: StudyLog[] = [
  // FAR study logs — 19 chapters, spread from mid-Jan to today. Recall ratings vary (scattered retention)
  { id: "sl-1", date: "2026-01-15", section: "FAR", chapterId: "far-ch1", chapterTitle: "Basic Concepts of Financial Accounting and Financial Statements", studyHours: 4.5, mcQuestions: 30, mcCorrect: 27, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 30, correctAnswers: 27, memo: "Conceptual framework and GAAP hierarchy. Solid grasp", recallRating: 3 },
  { id: "sl-2", date: "2026-01-17", section: "FAR", chapterId: "far-ch2", chapterTitle: "Presentation and Disclosure of Financial Statements and Concepts of Recognition and Measurement", studyHours: 4, mcQuestions: 28, mcCorrect: 22, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 28, correctAnswers: 22, memo: "Fair value measurement levels need revisiting", recallRating: 2 },
  { id: "sl-3", date: "2026-01-20", section: "FAR", chapterId: "far-ch3", chapterTitle: "Current Assets (Cash, Accounts Receivable, Inventory)", studyHours: 5.5, mcQuestions: 28, mcCorrect: 20, tbsQuestions: 7, tbsCorrect: 5, questionsAnswered: 35, correctAnswers: 25, memo: "LIFO/FIFO tricky. LCM and NRV rules. Bank rec TBS good", recallRating: 2 },
  { id: "sl-4", date: "2026-01-22", section: "FAR", chapterId: "far-ch4", chapterTitle: "Current Liabilities and Contingencies", studyHours: 3.5, mcQuestions: 22, mcCorrect: 18, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 22, correctAnswers: 18, memo: "Contingent liabilities SFAS 5 criteria clear", recallRating: 3 },
  { id: "sl-5", date: "2026-01-25", section: "FAR", chapterId: "far-ch5", chapterTitle: "Property, Plant, and Equipment", studyHours: 5, mcQuestions: 24, mcCorrect: 20, tbsQuestions: 6, tbsCorrect: 4, questionsAnswered: 30, correctAnswers: 24, memo: "Depreciation methods solid. Asset impairment ok", recallRating: 3 },
  { id: "sl-6", date: "2026-01-27", section: "FAR", chapterId: "far-ch6", chapterTitle: "Intangible Assets", studyHours: 3, mcQuestions: 20, mcCorrect: 16, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 20, correctAnswers: 16, memo: "Goodwill impairment 2-step test. R&D vs software dev costs", recallRating: 2 },
  { id: "sl-7", date: "2026-01-29", section: "FAR", chapterId: "far-ch7", chapterTitle: "Time Value of Money", studyHours: 4, mcQuestions: 18, mcCorrect: 11, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 18, correctAnswers: 11, memo: "Annuity due vs ordinary annuity still mixing up. PV calculations weak", recallRating: 1 },
  { id: "sl-8", date: "2026-01-31", section: "FAR", chapterId: "far-ch8", chapterTitle: "Bonds", studyHours: 5, mcQuestions: 20, mcCorrect: 12, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 25, correctAnswers: 15, memo: "Effective interest method confusing. Premium/discount amort needs drill", recallRating: 1 },
  { id: "sl-9", date: "2026-02-02", section: "FAR", chapterId: "far-ch9", chapterTitle: "Lease Accounting for Lessee", studyHours: 4.5, mcQuestions: 18, mcCorrect: 10, tbsQuestions: 4, tbsCorrect: 3, questionsAnswered: 22, correctAnswers: 13, memo: "ASC 842 ROU asset and lease liability. Finance vs operating still shaky", recallRating: 1 },
  { id: "sl-10", date: "2026-02-04", section: "FAR", chapterId: "far-ch10", chapterTitle: "Notes Receivable and Payable", studyHours: 3, mcQuestions: 18, mcCorrect: 14, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 18, correctAnswers: 14, memo: "Note discount and imputation of interest. Straightforward", recallRating: 2 },
  { id: "sl-11", date: "2026-02-06", section: "FAR", chapterId: "far-ch11", chapterTitle: "Revenue from Contracts with Customers", studyHours: 5, mcQuestions: 20, mcCorrect: 13, tbsQuestions: 5, tbsCorrect: 3, questionsAnswered: 25, correctAnswers: 16, memo: "ASC 606 5-step model. Variable consideration and SSP allocation complex", recallRating: 1 },
  { id: "sl-12", date: "2026-02-08", section: "FAR", chapterId: "far-ch12", chapterTitle: "Equity Transactions and Earnings Per Share", studyHours: 4, mcQuestions: 18, mcCorrect: 12, tbsQuestions: 4, tbsCorrect: 3, questionsAnswered: 22, correctAnswers: 15, memo: "Basic EPS ok. Diluted EPS with convertible bonds/options needs work", recallRating: 1 },
  { id: "sl-13", date: "2026-02-10", section: "FAR", chapterId: "far-ch13", chapterTitle: "Investments", studyHours: 4, mcQuestions: 20, mcCorrect: 14, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 20, correctAnswers: 14, memo: "HTM, trading, AFS classification. Equity method threshold", recallRating: 2 },
  { id: "sl-14", date: "2026-02-12", section: "FAR", chapterId: "far-ch14", chapterTitle: "Preparation of Consolidated Financial Statements and Adjustments Subsequent to Combination", studyHours: 6, mcQuestions: 22, mcCorrect: 12, tbsQuestions: 6, tbsCorrect: 4, questionsAnswered: 28, correctAnswers: 16, memo: "Elimination entries and NCI calculations very challenging", recallRating: 0 },
  { id: "sl-15", date: "2026-02-14", section: "FAR", chapterId: "far-ch15", chapterTitle: "Deferred Taxes", studyHours: 4.5, mcQuestions: 22, mcCorrect: 14, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 22, correctAnswers: 14, memo: "Temporary vs permanent differences. Valuation allowance rules", recallRating: 1 },
  { id: "sl-16", date: "2026-02-16", section: "FAR", chapterId: "far-ch16", chapterTitle: "Statement of Cash Flows", studyHours: 4, mcQuestions: 20, mcCorrect: 15, tbsQuestions: 5, tbsCorrect: 4, questionsAnswered: 25, correctAnswers: 19, memo: "Indirect method adjustments. Operating/investing/financing classification clear", recallRating: 3 },
  { id: "sl-17", date: "2026-02-18", section: "FAR", chapterId: "far-ch17", chapterTitle: "Accounting Changes and Error Corrections", studyHours: 3.5, mcQuestions: 18, mcCorrect: 12, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 18, correctAnswers: 12, memo: "Retrospective vs prospective application. Error correction restatement", recallRating: 2 },
  { id: "sl-18", date: "2026-02-20", section: "FAR", chapterId: "far-ch18", chapterTitle: "Miscellaneous Topics", studyHours: 3, mcQuestions: 15, mcCorrect: 11, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 15, correctAnswers: 11, memo: "Segment reporting, interim reporting, subsequent events", recallRating: 2 },
  { id: "sl-19", date: "2026-02-22", section: "FAR", chapterId: "far-ch19", chapterTitle: "Financial Statement Ratios and Performance Metrics", studyHours: 2.5, mcQuestions: 12, mcCorrect: 8, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 12, correctAnswers: 8, memo: "Just started. Liquidity and profitability ratios", recallRating: 1 },
  // REG study logs — Business Law (ch1-11) + Taxation start (ch12-13)
  { id: "sl-20", date: "2026-01-20", section: "REG", chapterId: "reg-ch1", chapterTitle: "Overview of the Business Law", studyHours: 3, mcQuestions: 22, mcCorrect: 18, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 22, correctAnswers: 18, memo: "Sources of law, constitutional fundamentals. Clear", recallRating: 3 },
  { id: "sl-21", date: "2026-01-23", section: "REG", chapterId: "reg-ch2", chapterTitle: "Contracts", studyHours: 4.5, mcQuestions: 22, mcCorrect: 16, tbsQuestions: 6, tbsCorrect: 5, questionsAnswered: 28, correctAnswers: 21, memo: "Offer/acceptance, consideration, Statute of Frauds. UCC vs Common Law", recallRating: 2 },
  { id: "sl-22", date: "2026-01-25", section: "REG", chapterId: "reg-ch3", chapterTitle: "Sales", studyHours: 3, mcQuestions: 20, mcCorrect: 14, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 20, correctAnswers: 14, memo: "UCC Article 2, risk of loss, warranties. Merchant rules tricky", recallRating: 2 },
  { id: "sl-23", date: "2026-01-28", section: "REG", chapterId: "reg-ch4", chapterTitle: "Agency", studyHours: 2.5, mcQuestions: 18, mcCorrect: 14, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 18, correctAnswers: 14, memo: "Actual vs apparent authority. Principal liability for torts", recallRating: 2 },
  { id: "sl-24", date: "2026-01-30", section: "REG", chapterId: "reg-ch5", chapterTitle: "Real Property", studyHours: 3.5, mcQuestions: 20, mcCorrect: 13, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 20, correctAnswers: 13, memo: "Types of deeds, recording statutes, landlord-tenant. Need to review", recallRating: 1 },
  { id: "sl-25", date: "2026-02-01", section: "REG", chapterId: "reg-ch6", chapterTitle: "Suretyship", studyHours: 2.5, mcQuestions: 15, mcCorrect: 11, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 15, correctAnswers: 11, memo: "Surety vs guarantor, co-surety contribution rights", recallRating: 2 },
  { id: "sl-26", date: "2026-02-04", section: "REG", chapterId: "reg-ch7", chapterTitle: "Secured Transaction", studyHours: 3.5, mcQuestions: 18, mcCorrect: 12, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 18, correctAnswers: 12, memo: "UCC Article 9. Attachment/perfection/priority. PMSI priority rules complex", recallRating: 1 },
  { id: "sl-27", date: "2026-02-06", section: "REG", chapterId: "reg-ch8", chapterTitle: "Bankruptcy", studyHours: 3, mcQuestions: 16, mcCorrect: 11, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 16, correctAnswers: 11, memo: "Ch 7 vs 11 vs 13 distinctions. Priority of claims in liquidation", recallRating: 2 },
  { id: "sl-28", date: "2026-02-09", section: "REG", chapterId: "reg-ch9", chapterTitle: "Business Structure", studyHours: 4, mcQuestions: 18, mcCorrect: 12, tbsQuestions: 4, tbsCorrect: 3, questionsAnswered: 22, correctAnswers: 15, memo: "LLC, LLP, GP, LP formation and liability. Partnership dissolution", recallRating: 2 },
  { id: "sl-29", date: "2026-02-12", section: "REG", chapterId: "reg-ch10", chapterTitle: "Governmental Regulations and Professional Responsibilities", studyHours: 3, mcQuestions: 18, mcCorrect: 13, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 18, correctAnswers: 13, memo: "AICPA Code of Conduct, Circular 230 penalties", recallRating: 2 },
  { id: "sl-30", date: "2026-02-15", section: "REG", chapterId: "reg-ch11", chapterTitle: "Federal Securities Act", studyHours: 3.5, mcQuestions: 20, mcCorrect: 14, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 20, correctAnswers: 14, memo: "Securities Act 1933 vs 1934. Registration exemptions, Rule 10b-5", recallRating: 1 },
  { id: "sl-31", date: "2026-02-18", section: "REG", chapterId: "reg-ch12", chapterTitle: "Introduction to Taxation", studyHours: 3, mcQuestions: 18, mcCorrect: 14, tbsQuestions: 0, tbsCorrect: 0, questionsAnswered: 18, correctAnswers: 14, memo: "Tax formula, filing status, dependents. Fairly intuitive", recallRating: 3 },
...
export const INITIAL_MOCK_EXAMS: MockExam[] = [
  { id: "me-1", date: "2026-02-01", section: "FAR", source: "Becker", mcQuestions: 33, mcCorrect: 20, tbsQuestions: 8, tbsCorrect: 4, totalQuestions: 41, totalCorrect: 24, accuracy: 58.5, memo: "First attempt halfway through. Inventory and TVM weak" },
  { id: "me-2", date: "2026-02-13", section: "FAR", source: "Becker", mcQuestions: 36, mcCorrect: 25, tbsQuestions: 8, tbsCorrect: 5, totalQuestions: 44, totalCorrect: 30, accuracy: 68.2, memo: "Consolidation entries destroyed me. Cash flows ok" },
  { id: "me-3", date: "2026-02-21", section: "FAR", source: "Becker", mcQuestions: 40, mcCorrect: 30, tbsQuestions: 10, tbsCorrect: 7, totalQuestions: 50, totalCorrect: 37, accuracy: 74.0, memo: "Improving. Leases and deferred tax still risky. NFP/Gov not yet covered" },
  { id: "me-4", date: "2026-02-16", section: "REG", source: "Wiley", mcQuestions: 30, mcCorrect: 19, tbsQuestions: 5, tbsCorrect: 3, totalQuestions: 35, totalCorrect: 22, accuracy: 62.9, memo: "Business law only. Secured transactions and real property weak" },
]

export const INITIAL_ESSENCE_NOTES: EssenceNote[] = []

export const INITIAL_PROGRESS: StudyProgress[] = [
  { section: "FAR", questionsAnswered: 375, correctAnswers: 270, totalQuestions: 400, studyHours: 75.5, lastStudied: "2026-02-22", streak: 5 },
